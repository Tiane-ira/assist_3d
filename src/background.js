...
function resetIndexWithSlow(indexGroup, index, ruleGroupLens, slowRowArr, slowRowIndexArr) {
                ...
                for (let moveRowArr of moveRowArrList) {
                    for (let i = moveRowArr.length - 1; i >= 0; i--) {
                        ...
                        if (slowRowArr.length > 0) {
                            let slowRowIndexArrList = getSlowRowIndexArrList(index, slowRowArr, ruleGroupLens)
